...
// While we prefer CJS, we need to support AMD for Firebird's sake.
if (typeof define === 'function' && define.amd) {
  define ('region', [], function () { return regionExport; });
}
else {
// If not AMD, assume CJS.
  module.exports = regionExport;
}
